...
class Pokemon(models.Model):
    ...
    heigth = models.DecimalField(decimal_places=3, max_digits=2, null=False, blank=False)
    weigth = models.DecimalField(decimal_places=3, max_digits=2, null=False, blank=False)
    ...
    hidden_ability = models.ForeignKey(Ability, on_delete=models.SET_NULL, related_name='hidden_ability')
...
class Training(models.Model):
    ...
    catch_rate = models.DecimalField(decimal_places=3, max_digits=2, null=False, blank=False)
    friendship_category = models.ForeignKey(FriendShipCategory, on_delete=models.SET_NULL, related_name='friendship_category')
    base_friendship = models.PositiveIntegerField()
    growth_rate = models.ForeignKey(GrowthRateCategory, on_delete=models.SET_NULL, related_name='growth_rate')
...
class Breeding(models.Model):
    ...
    egg_cycles_category = models.ForeignKey(EggCyclesCategory, on_delete=models.SET_NULL, related_name='egg_cycles_category')
